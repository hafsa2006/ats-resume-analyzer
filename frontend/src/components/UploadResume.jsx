...
export default function UploadResume({ file, onFileChange, error }) {
  ...
  return (
    <div className="w-full" onDrop={handleDrop} onDragOver={handleDragOver}>
      ...
      <button
        ...
        className="w-full glass-card rounded-2xl p-8 text-center transition-all hover:border-primary/40 hover:shadow-glow focus:outline-none focus:ring-2 focus:ring-primary/40 min-h-[200px] flex flex-col items-center justify-center gap-3"
      >
        {file ? (
